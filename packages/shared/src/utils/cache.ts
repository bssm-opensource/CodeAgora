 ...
 */
export async function readCacheIndex(caRoot: string): Promise<CacheIndex> {
 ...
 */
export async function lookupCache(caRoot: string, cacheKey: string): Promise<string | null> {
